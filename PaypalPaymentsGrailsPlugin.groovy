class PaypalPaymentsGrailsPlugin {
    ...
    def title = "Paypal Payments Plugin"
    def author = "Omasirichukwu Joseph Udeinya"
    def authorEmail = "omasiri@novadge.com"
    def description = 'Lets Grails applications accept and process payments with Paypal REST API'
    def documentation = "http://grails.org/plugin/paypal"
    def license = "APACHE"
    def organization = [name: "Novadge", url: "http://www.novadge.com/"]
    def issueManagement = [url: "http://github.com/Novadge/paypal-payments/issues"]
